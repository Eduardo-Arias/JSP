<%-- 
    Document   : grupo_eliminar
    Created on : 29/11/2016, 10:13:26 PM
    Author     : eduardo
--%>
...
<body>
    <nav class="navbar navbar-inverse">
        ...
        <div class="panel panel-danger" id="panelPrimary">
            <div class="panel-heading">Eliminar Grupo</div>
                    ...
                    <tbody>
                        <c:forEach items="${grupos}" var="grupo">
                            <tr>
                                ...
                                <td>${grupo.estado}</td>
                                <td>
                                    <a  href="GrupoController?action=borrar&cveGrupo=${grupo.cveGrupo}"
